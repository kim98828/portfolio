...
// ── 라이브 운영: VJ·TD·시스템 관리자 1년 + 위기대처 (위조 불가 신호) ──
    {
        ...
        tag: 'Delivery',
        title: '공통 — VJ·TD·라이브 시스템 관리자로 1년간 실시간 운영',
        problem: '기술을 구현하는 것과, 관객 앞 라이브에서 그것을 안 터지게 굴리는 것은 다른 역량이다. 방송·공연 중 장애는 되돌릴 수 없고 재시도가 없다.',
        solution: '직접 구축한 렌더링·방송·모캡 파이프라인을 VJ / TD / 라이브 시스템 관리자로서 [약 1년] 실제 운영. 라이브 송출·공연 중 발생하는 장애를 실시간 진단·복구하고, 반복 운영으로 시스템을 안정화. [측정: 무중단 송출 시간, 라이브 횟수, 장애 복구 시간 등]',
